...
[^5]: The "Observability 2.0" framing (O11y 1.0 vs 2.0) first took shape in a [Charity Majors thread](https://x.com/mipsytipsy/status/1738069788570841299) on 2023-12-22, following her October 2023 thread on "losing the battle to define observability". She wrote it out properly in [*Is It Time To Version Observability? (Signs Point To Yes)*](https://charity.wtf/p/is-it-time-to-version-observability-signs-point-to-yes) (2024-08-07), which opens by noting she had been meaning to write it since December; the sharpest statement of the idea is [*There Is Only One Key Difference Between Observability 1.0 and 2.0*](https://www.honeycomb.io/blog/one-key-difference-observability1dot0-2dot0) (2024-11).
